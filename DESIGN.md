...
- [biospheres design](#biospheres-design)
...
`biospheres` is designed to be the set of first-class adapters for the `solarsystem` multi-cloud serverless framework.

## How is it different from what I already use?

**WORK IN PROGRESS**: `biospheres` is still in the `design` phase.
...
`biospheres` is a part of the [Open Source Universe](https://github.com/intellibus/approach). All Projects in the [Open Source Universe](https://github.com/intellibus/approach) follow the same [Contribution Guidelines & Process](https://github.com/intellibus/approach).
...
`biospheres` only plans to initially support Typescript & JavaScript Applications. However, we would love for the community to contribute versions for other languages (Java, Go, etc.)
